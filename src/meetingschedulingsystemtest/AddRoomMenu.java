...
public class AddRoomMenu extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        // validates the room number and makes sure the room doesn't already exist
        for(int i=0;i<MSSMM.roomArray.size();i++){
           ...
           if(roomNumber.equals(roomNum)){
               dispose();        
               JOptionPane.showMessageDialog(null, "That room exists already!", "Error", JOptionPane.ERROR_MESSAGE);
               addRoomMenu.setVisible(true);
               return;
           }
       }
